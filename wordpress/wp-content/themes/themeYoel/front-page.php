<?php get_header(); // Incluye el header.php ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="group bg-gray-50 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <p class="font-cuerpo text-gray-600 text-justify">Descubre estrategias de alta precisión que te ayudarán a
                ...
                <div class="group bg-gray-50 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    ...
                    <div class="p-8 text-center hover:border-yellow-500">
                        ...
                        <p class="font-cuerpo text-gray-600 text-justify">Recibe guía continua de un trader profesional, Yoel Montes,
